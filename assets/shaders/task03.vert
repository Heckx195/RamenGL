...
void main()
{
    ...
    out_Normal = normalize(normalMatrix * in_Normal); // inverse-transponierte kann Laenge des Vektors ändern, brauchen für Skalarprodukt aber L=1 sonst falscher Cos
