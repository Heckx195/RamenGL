...
=== Implementierung
==== Vertex-Shader
- Der Normalenvektor mit der Inversen Transponierten der Modellmatrix (_normalMatrix_) transformiert, um sicherzustellen, dass die Normalen korrekt transformiert werden.
...
==== Fragment-Shader
- _N_ aus den interpolierten Normalenvektoren berechnet und normalisiert.
